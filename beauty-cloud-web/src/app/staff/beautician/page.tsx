import { BeauticianScheduleView } from "@/components/beautician/beautician-schedule";
import { StaffShell } from "@/components/layout/staff-shell";
import { requireStaffSession } from "@/lib/auth/staff-guard";
import { getPublicBootstrap } from "@/lib/frappe/bootstrap";

export const metadata = { title: "Beautician" };
...
export default async function BeauticianPage() {
  ...
  return (
    <StaffShell bootstrap={bootstrap} session={session}>
      <h2 className="mb-6 text-2xl font-semibold">Beautician tablet</h2>
      <BeauticianScheduleView />
    </StaffShell>
  );
}
